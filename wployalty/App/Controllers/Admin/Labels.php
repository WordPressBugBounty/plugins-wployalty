	...
	public static function getPluginLabels() {
		...
		$json               = [
			...
			'common'          => [
				...
				'email_notice_text'                  => __( 'WooCommerce has updated its email functionality, adding features such as live previews and improved shortcode processing. We’ve rolled out a new email template that fully supports these updates. Please note that the old email template will be removed in the next WPLoyalty release.', 'wp-loyalty-rules' ),
