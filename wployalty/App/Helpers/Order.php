...
class Order extends Base {
	...
	function get_eligible_order_price( $rule, $action_data ) {
		...
		$is_earn_point_after_discount = is_array( $settings ) && isset( $settings['is_earn_point_after_discount'] ) && ! empty( $settings['is_earn_point_after_discount'] ) && in_array( $settings['is_earn_point_after_discount'], array(
			'yes',
			'no'
